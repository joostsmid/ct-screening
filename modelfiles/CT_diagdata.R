...
get.CT.diagdata <- function(age.classes){
  ...
  diag_chandra_array <- to.tensor(NA, dims = list(sex=sex, screencatage=paste0('screencatage', agecategories),minmax=minmax,screening_y = years))
  diag_chandra_array["M",1,1,] <- diag_chandra$M_min_1519
  diag_chandra_array["M",1,2,] <- diag_chandra$M_max_1519
  diag_chandra_array["M",2,1,] <- diag_chandra$M_min_2024
  diag_chandra_array["M",2,2,] <- diag_chandra$M_max_2024
  diag_chandra_array["M",3,1,] <- diag_chandra$M_min_2534
  diag_chandra_array["M",3,2,] <- diag_chandra$M_max_2534
  diag_chandra_array["M",4,1,] <- diag_chandra$M_min_3544
  diag_chandra_array["M",4,2,] <- diag_chandra$M_max_3544
  diag_chandra_array["F",1,1,] <- diag_chandra$F_min_1519
  diag_chandra_array["F",1,2,] <- diag_chandra$F_max_1519
  diag_chandra_array["F",2,1,] <- diag_chandra$F_min_2024
  diag_chandra_array["F",2,2,] <- diag_chandra$F_max_2024
  diag_chandra_array["F",3,1,] <- diag_chandra$F_min_2534
  diag_chandra_array["F",3,2,] <- diag_chandra$F_max_2534
  diag_chandra_array["F",4,1,] <- diag_chandra$F_min_3544
  diag_chandra_array["F",4,2,] <- diag_chandra$F_max_3544
  ...
  diag <- margin.tensor(norm.years.in.categories * diag_chandra_array, i=2)
  diag <- reorder.tensor(diag, c(2,1,3,4))
